...
const Auth = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const { data } = await api.post(`${import.meta.env.VITE_API_URL || 'http://13.235.26.67'}/api/auth/login`, { email, password });
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            const { data } = await api.post(`${import.meta.env.VITE_API_URL || 'http://13.235.26.67'}/api/auth/register`, { fullname, username, email, password, githubProfile });
